...
$requests_data = mysqli_fetch_assoc($result);
...
<body>
    ...
    <main>     
        ...
        <div class="item">
            ...
            <p style="text-align:left;"><?php echo isset($requests_data['RequestsMade']) ? $requests_data['RequestsMade'] : '0'; ?></p></b>
        </div>
        <div class="item">
            ...
            <p style="text-align:left;"><?php echo isset($requests_data['PendingRequests']) ? $requests_data['PendingRequests'] : '0'; ?></p></b>
        </div>
        <div class="item">
            ...
            <p style="text-align:left;"><?php echo isset($requests_data['ApprovedRequests']) ? $requests_data['ApprovedRequests'] : '0'; ?></p></b>
        </div>
        <div class="item">
            ...
            <p style="text-align:left;"><?php echo isset($requests_data['RejectedRequests']) ? $requests_data['RejectedRequests'] : '0'; ?></p></b>
        </div>
