...
if (isset($_POST['submit'])) {
    ...
    $insert = "INSERT INTO donationshistory (id, blood_group, diseases, units, date, status) VALUES ('$id', '$BloodGroup', '$diseases', '$units', current_timestamp(), '$status')";
...
<div class="form-container" style="background-color:#192e3f">
   <form action="" method="post">
      ...
      ?>
      <input type="text" name="diseases" required placeholder="Enter Your Diseases(If Any)" value="<?php echo $diseases; ?>">
      ...
      <input type="submit" name="submit" value="Donate Blood" class="form-btn">
   </form>
</div>
</body>
</html>
